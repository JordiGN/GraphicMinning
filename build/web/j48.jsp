...
<%    
        ...
        eval.crossValidateModel(cls,training_data,10, new Random(1));
        ...
        JFreeChart chart = ChartFactory.createBarChart("J48 Clasification","Medicion", "Porcentaje", dataset, PlotOrientation.VERTICAL, false,true, false);
